 ...
 */
 function fancy_lab_scripts(){
     ...
     wp_enqueue_script( 'flexslider-min-js', get_template_directory_uri() . '/js/jquery.flexslider-min.js', array( 'jquery' ), '2.7.2', true );
     wp_enqueue_style( 'flexslider-css', get_template_directory_uri() . '/css/flexslider.css', array(), '', 'all' );
     wp_enqueue_script( 'flexslider-js', get_template_directory_uri() . '/js/flexslider.js', array( 'jquery' ), '2.7.2', true );
 }
